              ...
              <div className="row">
                <div className="col-xl-3 col-lg-3 col-md-4 col-sm-6">
	                  <div className="tp-footer-widget footer-col-4-1 mb-50">
                        ...
                        <h4><a href="https://wa.me/923700030710">+92 3700030710</a></h4>
                      </div>
                      <div className="tp-footer-contact">
                        ...
                        <div className="tp-footer-contact-item d-flex align-items-start">
                          ...
                          <div className="tp-footer-contact-content">
                            <p><a href="https://maps.app.goo.gl/cLCsrbirwTH8wFz48" target="_blank">Office No 602 6TH Floor AL-Hafeez Heights <br /> AL-Hafeez Height Gulberg 3 Lahore, Pakistan</a></p>
                          </div>
                        </div>
                      </div>
                    </div>
