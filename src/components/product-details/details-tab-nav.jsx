...
import FormattedDescription, { parseProductDescription } from './formatted-description';
...
const DetailsTabNav = ({ product }) => {
  ...
  const descriptionSections = parseProductDescription(description);
                    ...
                    <div className="row align-items-center">
                      <div className="col-lg-12">
                        <div className="tp-product-details-desc-content">
                          <FormattedDescription sections={descriptionSections} />
                        </div>
                      </div>
                    </div>
                  </div>
