        ...
        <div className="tp-product-content">
          ...
          <div className="tp-product-price-wrapper">
            {purchasable && discount > 0 ? (
              <>
                <span className="tp-product-price old-price">PKR {price}</span>
                <span className="tp-product-price new-price">
                  {" "}PKR {(Number(price) - (Number(price) * Number(discount)) / 100).toFixed(2)}
                </span>
              </>
            ) : purchasable ? (
              <span className="tp-product-price new-price">PKR {parseFloat(price).toFixed(2)}</span>
            ) : (
              <span className="tp-product-price new-price">Professional Inquiry</span>
            )}
          </div>
