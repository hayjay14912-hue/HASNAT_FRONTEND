...
// internal
import banner_img_1 from '@assets/img/product/banner/product-banner-1.jpg';
import banner_img_2 from '@assets/img/product/banner/product-banner-2.jpg';
                    ...
                    <div className="col-xl-6 col-lg-6">
                      <div className="tp-product-banner-content p-relative z-index-1">
                        ...
                        <div className="tp-product-banner-price mb-40">
                          <span className="old-price">PKR {item.oldPrice.toFixed(2)}</span>
                          <p className="new-price">PKR {item.newPrice.toFixed(2)}</p>
                        </div>
